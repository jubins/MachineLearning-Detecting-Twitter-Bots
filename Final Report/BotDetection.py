...
class twitter_bot(object):
    ...
    def bot_prediction_algorithm(df):
        ...
        if train_df.shape[0]>600:
            ...
            bag_of_words_bot = r'bot|b0t|cannabis|tweet me|mishear|follow me|updates every|gorilla|yes_ofc|forget' \
                           ...
                           r'ffd|onlyman|emoji|joke|troll|droop|free|every|wow|cheese'
        else:
            # bag_of_words_for_bot
    ...
    def plot_roc_curve(df):
        ...
        plt.plot(fpr_test,tpr_test, label='Test AUC: %5f' %metrics.auc(fpr_test,tpr_test), ls='--', color='lightblue')
        #Misc
        plt.plot(threshold, ls='--', color='red', label="Threshold line")
        plt.xlim([-0.1,1])
        plt.plot([0,1],[0,1], color='black', label="45 degree line")
